...
for season in range(1, 3):
    num_pages = 1
    filename = "data/daredevil/rottentomatoes/critic-reviews-season-" + str(season) + "-1"
    with open(filename, 'wb') as handle:
        file = "https://www.rottentomatoes.com/tv/daredevil/s0" + \
            str(season) + "/reviews"
    ...
    if num_pages > 1:
        for page in range(2, num_pages + 1):
            filename = "data/daredevil/rottentomatoes/critic-reviews-season-" \
                + str(season) + "-" + str(page)
            with open(filename, 'wb') as handle:
                file = "https://www.rottentomatoes.com/tv/daredevil/s0" + \
...
for season in range(1, 3):
    num_pages = 1
    filename = "data/daredevil/rottentomatoes/audience-reviews-season-" + str(season) + "-1"
    with open(filename, 'wb') as handle:
        file = "https://www.rottentomatoes.com/tv/daredevil/s0" + \
    ...
    if num_pages > 1:
        for page in range(2, num_pages + 1):
            filename = "data/daredevil/rottentomatoes/audience-reviews-season-" \
                + str(season) + "-" + \
                str(page)
            with open(filename, 'wb') as handle:
                file = "https://www.rottentomatoes.com/tv/daredevil/s0" + \
